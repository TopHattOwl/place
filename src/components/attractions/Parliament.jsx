...
import parliamentImg from '../../assets/parliamentDetail.jpg';

const Parliament = () => {
  return (
    <section id="parliament-details" className="py-5">
      ...
      <div className="container">
        ...
        <div className='row'>
          ...
          <div className='col-md-4'>
            <img src={parliamentImg} alt="Országház" className="img-fluid" />
          </div>
